...
import com.seadro.notesx.fragment.NotesXFragment;
import com.seadro.notesx.utils.FontCache;
import com.seadro.notesx.utils.Misc;
import com.seadro.notesx.utils.PreferenceHandler;
import com.seadro.notesx.utils.TimeoutHandler;
import com.seadro.notesx.view.simplelist.SimpleListFragment;
import com.seadro.notesx.view.staggeredgrid.StaggeredGridFragment;
 ...
 */
public class NotesXActivity extends Activity
        implements SharedPreferences.OnSharedPreferenceChangeListener {
    public final static String TAG = "NotesXActivity";
    ...
    private NotesXFragment mNotesXFragment;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (NotesXApplication.getDatabase().getPassword() == null) {
...
//        AppRater.app_launched(this);
    ...
    private void loadNotesView() {
        ...
        switch (type) {
            case VIEW_TILES:
                mNotesXFragment = new StaggeredGridFragment();
                break;
            case VIEW_COLUMN:
                mNotesXFragment = new StaggeredGridFragment();
                break;
            case VIEW_SIMPLE_LIST:
                mNotesXFragment = new SimpleListFragment();
                break;
        }
        ...
        mNotesXFragment.setArguments(bundle);

        FragmentTransaction transaction = getFragmentManager().beginTransaction();
        transaction.replace(R.id.fragment_container, mNotesXFragment);
        transaction.commit();
    }
    ...
    private void initNavigationDrawer() {
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,
            ...
            public void onDrawerClosed(View view) {
                ...
                if (mReloadFragment) {
                    mNotesXFragment.setFolder(mCurrentFolder,  mTagId);
    ...
    private void reloadTagsAdapter() {
        DatabaseHandler handler = NotesXApplication.getDatabase();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_new_note_card:
                NoteActivity.startForNoteId(NotesXActivity.this, -1, Note.Type.TYPE_CARD);
                return true;
            case R.id.action_new_note_login:
                NoteActivity.startForNoteId(NotesXActivity.this, -1, Note.Type.TYPE_LOGIN);
                return true;
    ...
    public void onCreateNoteClick(View view) {
        NoteActivity.startForNoteId(NotesXActivity.this, -1, null);
    }
