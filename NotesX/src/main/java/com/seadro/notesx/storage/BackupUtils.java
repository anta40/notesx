package com.seadro.notesx.storage;
...
public class BackupUtils {
    ...
    public static File backupDatabase(Context context) throws IOException {
        ...
        if (isExternalStorageReadable() && isExternalStorageWritable()) {
            backupFile = new File(context.getExternalCacheDir(), "notesx-backup.db");
    ...
    public static File restoreDatabase(Context context, File file) throws IOException {
        DatabaseHandler dbHandler = NotesXApplication.getDatabase();
        dbHandler.close();
        dbHandler.recycle();
