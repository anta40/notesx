...
import com.seadro.notesx.fragment.ColorDialogFragment;
import com.seadro.notesx.utils.EasyDate;
...
import com.seadro.notesx.view.NoteView;
import com.seadro.notesx.view.TagEditText;
...
public class NoteActivity extends Activity implements ColorDialogFragment.ColorChangedListener {
    ...
    private void init(boolean isNewNote, Note.Type type) {
        ...
        mTagEditText.loadSuggestions(NotesXApplication.getDatabase().getAllTags().keySet());
    ...
    public boolean saveNote(boolean forceSave) {
        final DatabaseHandler handler = NotesXApplication.getDatabase();
        final String title = mTitleView.getText().toString();
        final NoteContent noteContent = mNoteView.getNoteContent();
        final String text = noteContent.toString();
    ...
    private class NoteLoadTask extends AsyncTask<Integer, Void, Note> {
        ...
        protected Note doInBackground(Integer... integers) {
            DatabaseHandler db = NotesXApplication.getDatabase();
