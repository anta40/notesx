...
import com.seadro.notesx.view.PasswordInput;
...
public class PasswordActivity extends Activity {
    ...
    private class LoginTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... args) {
            ...
            handler.recycle();
            try {
                NotesXApplication.getDatabase().setPassword(args[0]);
                handler.update();
        ...
        protected void onPostExecute(Boolean result) {
            if (result) {
                ...
                Intent intent = new Intent(PasswordActivity.this, NotesXActivity.class);
