...
public class AdapterLoader extends AsyncTaskLoader<Cursor> {
    ...
    public Cursor loadInBackground() {
        Log.d(NotesXFragment.TAG, "Adapter loader started!");

        final DatabaseHandler db = NotesXApplication.getDatabase();
        final Cursor cursor;
    ...
    public AdapterLoader(Context context, Note.Folder currentFolder, int tagid) {
        super(context);
        Log.d(NotesXFragment.TAG, "New adapter loader created");
