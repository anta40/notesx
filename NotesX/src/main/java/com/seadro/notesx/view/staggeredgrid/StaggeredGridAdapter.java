package com.seadro.notesx.view.staggeredgrid;
...
import com.seadro.notesx.NoteActivity;
import com.seadro.notesx.data.CardGridStaggeredCursorAdapter;
import com.seadro.notesx.data.DatabaseHandler;
import com.seadro.notesx.data.Note;
import com.seadro.notesx.data.NotesXAdapter;
import com.seadro.notesx.internal.NotesXCard;

import it.gmariotti.cardslib.library.internal.Card;
import it.gmariotti.cardslib.library.view.CardView;

/**
 * Adapter for NotexSStaggeredGrid. Initialized cards and their event listeners. Since
 ...
 */
public class StaggeredGridAdapter extends CardGridStaggeredCursorAdapter implements NotesXAdapter {
     ...
     * @return          NotesXCard object initialized with CAB listeners and data
     */
    @Override
    protected Card getCardFromCursor(Cursor cursor) {
        NotesXCard card = new NotesXCard(super.getContext());
    ...
    protected void initCardListeners(Card card) {
        card.setOnClickListener(new Card.OnCardClickListener() {
            ...
            public void onClick(Card card, View view) {
                NotesXCard sCard = (NotesXCard) card;
     ...
     * icon clicks.
     */
    class MultiChoiceCallback extends com.seadro.notesx.internal.MultiChoiceCallback {
        /**
