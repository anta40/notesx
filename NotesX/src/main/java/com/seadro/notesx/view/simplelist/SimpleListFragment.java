package com.seadro.notesx.view.simplelist;
 ...
 */
public class SimpleListFragment extends NotesXFragment implements AdapterView.OnItemClickListener {
     ...
     */
    @Override
    protected NotesXAdapter createAdapter() {
        if (mAdapter == null) {
...
//        }
     ...
     */
    private class MultiChoiceCallback extends com.seadro.notesx.internal.MultiChoiceCallback
